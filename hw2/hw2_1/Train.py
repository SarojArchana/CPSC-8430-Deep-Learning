...
#Json Loader#
    with open('/home/test/Desktop/Hw2/MLDS_hw2_1_data/training_label.json', 'r') as f:
        file = json.load(f)
...
# def train(model, epoch, train_loader, loss_func):
    ...
    # for batch_idx, batch in enumerate(train_loader):
        ...
        # avi_feats, ground_truths = avi_feats, ground_truths.cuda()
...
def train(model, epoch, train_loader, loss_func):
    ...
    print(f'Epoch:{epoch}, Loss:{np.round(epoch_loss,3)}')
...
def main():
    ...
    label_file = '/home/test/Desktop/Hw2/MLDS_hw2_1_data/training_data/feat'
    files_dir = '/home/test/Desktop/Hw2/MLDS_hw2_1_data/training_label.json'
    i2w,w2i,dictonary = dictonaryFunc(4)
    train_dataset = Dataprocessor(label_file, files_dir,dictonary, w2i)
    train_dataloader = DataLoader(dataset = train_dataset, batch_size=5, shuffle=True, num_workers=4, collate_fn=minibatch)
    
    label_file = '/home/test/Desktop/Hw2/MLDS_hw2_1_data/testing_data/feat'
    files_dir = '/home/test/Desktop/Hw2/MLDS_hw2_1_data/testing_label.json'
    ...
    epochs_n = 15
    ModelSaveLoc = ('/home/test/Desktop/Hw2/Model')
    with open('/home/test/Desktop/Hw2/MLDS_hw2_1_data/i2wData.pickle', 'wb') as f:
         pickle.dump(i2w, f)
    ...
    torch.save(modeltrain, "{}/{}.h5".format(ModelSaveLoc, 'model0'))
